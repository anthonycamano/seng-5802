...
interface RideComponent {
  ...
  class SingleRide implements RideComponent {
    ...
    constructor(rideType: RideType, distance: number, baseFare: number, pricePerKm: number) {
  ...
  class CompositeRide implements RideComponent {
    ...
    getDescription(): string {
      ...
      const descriptions = this.components.map(component => component.getDescription());
  ...
  function clientCode() {
    ...
    console.log(`Standard Ride with Surge Fare: $${standardRideWithSurge.calculateFare().toFixed(2)}`);
    console.log(`Standard Ride with Surge Description: ${standardRideWithSurge.getDescription()}`);
    console.log("---------------");
    
    console.log(`Premium Airport Ride Fare: $${premiumAirportRide.calculateFare().toFixed(2)}`);
    console.log(`Premium Airport Ride Description: ${premiumAirportRide.getDescription()}`);
    console.log("---------------");
    
    console.log(`Corporate Package Total Fare: $${corporatePackage.calculateFare().toFixed(2)}`);
    console.log(`Corporate Package Description: ${corporatePackage.getDescription()}`);
    ...
    console.log(`Updated Corporate Package Fare: $${corporatePackage.calculateFare().toFixed(2)}`);
    console.log(`Updated Corporate Package Description: ${corporatePackage.getDescription()}`);
  }
