...
(function (Memento) {
    ...
    var Material = /** @class */ (function () {
        ...
        Material.prototype.saveToMemento = function () {
            return new MaterialMemento(this._name, this._density, this._color, this._transparent);
        };
        // Restore state from a memento
        Material.prototype.restoreFromMemento = function (memento) {
    ...
    var MaterialForm = /** @class */ (function () {
        ...
        MaterialForm.prototype.saveState = function () {
        ...
        MaterialForm.prototype.redo = function () {
